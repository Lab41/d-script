...
def crop_using_heatmap(orig_im, heat2d):
    ...
    # max_raw / 2.0 == experimentally-determined (e.d.) peak representing the re-encounter of text, probably in the
    # signature line
    # 50 == with rule-lined paper, dropping below the median by some e.d. amount (50) probably means that we're in
    # non-text space
