...
def load_verbatimnet( layer, input_shape=(1,56,56), params='/fileserver/iam/iam-processed/models/fiel_1k.hdf5' ):
    ...
    vnet = verbatimnet(layer, input_shape=input_shape)
...
def extract_imfeats( hdf5name, network, shingle_dims=(56,56), steps=(20,20), outdir=None, compthresh=None ):
    ...
    for imname in hdf5file.keys():
        ...
        if outdir:
            print "Saving to "+outdir+imfeatures+".npy" 
            np.save( outdir+imfeatures+'.npy' , shards)
